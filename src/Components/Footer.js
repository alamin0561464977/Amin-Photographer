...
const Footer = () => {
    return (
        <div>
            <footer class="footer p-10 bg-base-200 text-base-content absolute bottom-12 container mx-auto">
                <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 absolute bottom-0 container mx-auto">
